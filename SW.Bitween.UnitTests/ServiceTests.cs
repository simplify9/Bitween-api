...
//        {
//            var settings = server.Services.GetService<BitweenSettings>();
...
//        //{
//        //    using var scope = server.Services.CreateScope();
//        //    var ctxt = scope.ServiceProvider.GetService<BitweenDbContext>();
...
//        //    if (sub == null) throw new BitweenException();
//        //    if (sub.KeySetId == 0) throw new BitweenException();

//        //    var ks = await dbContext.ListAsync(new AccessKeySetyByKey(sub.KeySetId, credential.Key));

//        //    if (ks.Count != 1) throw new BitweenException();
//        //}
