...
/// retrying for that integration until this row is cleared. It is cleared by the integration's next
/// success — the only signal that the downstream it was failing against has recovered — or by one of
/// the reset endpoints.
/// </remarks>
