            ...
            modelBuilder.Entity("SW.Bitween.Domain.Subscription", b =>
                {
                    b.HasOne("SW.Bitween.Domain.Subscription", null)
                        .WithOne()
                        .HasForeignKey("SW.Bitween.Domain.Subscription", "AggregationForId")
                    ...
                    b.HasOne("SW.Bitween.Domain.Subscription", null)
                        .WithOne()
                        .HasForeignKey("SW.Bitween.Domain.Subscription", "ResponseSubscriptionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.OwnsMany("SW.Bitween.Domain.Schedule", "AggregationSchedules", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                    ...
                    b.OwnsMany("SW.Bitween.Domain.Schedule", "ReceiveSchedules", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
